...
const Who = () => {
    ...
    return (
        ...
        <Hexagons startingI={40} startingJ={60} />
           ...
           <div className="w-full sm:w-1/3 md:pl-8 md:pt-8 md:w-1/2 flex flex-col justify-center">
            <div className="spin-container mt-[700px] lg:ml-20 xl:ml-0">
            <svg xmlns="http://www.w3.org/2000/svg" className="svghex absolute md:top-8 md:w-[200px] md:-left-2 xl:w-[380px] xl:top-28 xl:left-0 opacity-0" viewBox="0 0 1024 1024" version="1.1" fill="#fff" width="380px">
              ...
              <Image className="spinning-logo z-10 max-w-none md:w-[320px] xl:w-[700px]" src="/media/images/collective-finance-logo-spin.png" alt="Collective Finance" loading="eager" height={700} width={700}></Image>
              </div>
            </div>
            <Image className="assured -z-[1] absolute opacity-0 bottom-0 right-32 blur-lg" src="/media/images/assured-logo.png" alt="Assured" loading="eager" height={250} width={250}></Image>
         </div>
