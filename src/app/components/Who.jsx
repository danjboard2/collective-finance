    ...
    return (
        ...
        <Hexagons startingI={40} startingJ={60} />
           ...
           <div className="w-full sm:w-1/3 md:w-1/2 flex flex-col justify-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="svghex absolute lg:top-8 lg:w-[200px] lg:-left-2 xl:w-[380px] xl:top-28 xl:left-0 opacity-0" viewBox="0 0 1024 1024" version="1.1" fill="#fff" width="380px">
              ...
              <Image className="spinning-logo z-10 max-w-none lg:w-[320px] xl:w-[700px]" src="/media/images/collective-finance-logo-spin.png" alt="Collective Finance" loading="eager" height={700} width={700}></Image>
              </div>
            </div>
