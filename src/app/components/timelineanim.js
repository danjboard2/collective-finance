...
export default function TimelineAnims() {
  ...
  return (
      ...
      <section className="company-timeline one pt-[100px]" id="company-timeline">
          <div className="contain">
            ...
            <div className="timeline-heading overflow-x-clip">
                  <h2 className="year-2021 text-[220px] leading-[1] ml-[1000px] text-white  -mb-[450px] font-extrabold whitespace-nowrap">2023 Roadmap</h2>
                 </div>
      ...
      <div className="company-timeline-slider pl-[30px] sm:pl-[40px] md:pl-[60px] lg:pt-[120px] lg:pl-[180px] xl:pl-[190px] xxl:pl-[210px]">
