...
export default function TimelineAnims() {
  ...
  return (
      ...
      <section className="company-timeline one pt-[100px]" id="company-timeline">
          <div className="contain">
            ...
            <div className="timeline-heading overflow-x-clip">
                  <h2 className="year-2021 xl:text-[180px] xxl:text-[220px] leading-[1] ml-[1000px] text-white  -mb-[450px] font-extrabold whitespace-nowrap">2023 Roadmap</h2>
                 </div>
      ...
      <div className="company-timeline-slider pl-[30px] sm:pl-[40px] md:pl-[60px] lg:pt-[120px] lg:pl-[180px] xl:pl-[210px]">
        <div className="company-timeline-block active"><div className="block-inner"><span className="timeline-date">January</span><span className="circle"></span><h4 className="text-white xl:text-3xl xxl:text-4xl font-bold">First event happened.</h4><p className="text-white md:text-base lg:text-xl">Lorem ipsum dolor sit amet, consetetur lorem ips sadipscing elitr, sed diam nonumy eirmorem ipsum dolor sit amet, consetetur lorem ips sadipscing elitr, sed diam nonumy eirmod.d.</p></div></div>
