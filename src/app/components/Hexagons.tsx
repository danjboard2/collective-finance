    ...
    useEffect(() => {
      ...
      for (let i = startingI, j = startingJ; i < startingI + 20; i++, j++) {
        ...
        lastPositions.current[j] = updateAnimation(j, lastPositionHollow, 'Hollow', 'Hollow');
          ...
          newHexagons.push(
            <svg key={`filled-${i}`} data-index={`filled-${i}`} data-type="filled" style={{ ...filledHexagonStyle, position: 'absolute' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184.751 184.751" >
            <path d="M0,92.375l46.188-80h92.378l46.185,80l-46.185,80H46.188L0,92.375z"/>
          </svg>,
          <svg key={`hollow-${j}`} data-index={`hollow-${j}`} data-type="hollow" style={{ ...hollowHexagonStyle, position: 'absolute' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485.688 485.688">
